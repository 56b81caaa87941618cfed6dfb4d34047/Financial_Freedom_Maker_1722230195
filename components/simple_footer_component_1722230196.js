...
*/
Vue.component("simple_footer_component_1722230196", {
    template: `
                ...
                <div id="footer-content" class="text-center">
                    <div class="flex">
                        <a id="footer-logo-link" href="#" class="flex-1 flex items-center justify-center mb-5 text-2xl font-semibold text-gray-900 dark:text-white">
                            ...
                            FreedomApp: Unleash Your Potential
                        </a>
                    </div>
                </div>
                <div class="flex">
                    <div id="footer-text" class="flex-1 block text-sm text-center text-gray-500 dark:text-gray-400">
                        FreedomApp empowers you to break free from limitations and live life on your own terms. Join the movement towards ultimate liberty.
                    </div>
                </div>
            </div>
        </footer> 
